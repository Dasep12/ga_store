<div wire:key="product-table" wire:init="loadData">
        ...
        <div class="card-body position-relative">
            ...
            <div class="d-flex justify-content-between mb-2">
                <div>
                    ...
                    <button onclick="crudDepartment('create','*')" class="btn btn-sm bg-custom-navbar text-white"><i class="fa fa-plus-square"></i> Tambah Data</button>
                ...
                <table class="table table-sm table-hover table-bordered fs-8 table-responsive scrollbar">
                    <thead class="bg-custom-navbar">
                        <tr>
                            ...
                            <th class="text-white" scope="col">Nama Department</th>
                            ...
                            <td align="center">
                                <div class="btn-reveal-trigger position-static"><button class="btn btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-cog fs-10"></span></button>
                                    <div class="dropdown-menu dropdown-menu-end py-2">
                                        <button onclick="crudDepartment('edit','{{ $data->id }}')" class="dropdown-item text-primary btnEdit"><i class="fa fa-eye"></i> View</button>
                                        <div class="dropdown-divider"></div>
                                        <button onclick="crudDepartment('delete','{{ $data->id }}')" class="dropdown-item text-danger btnDelete" href="#!"><i class="fa fa-trash"></i> Remove</button>
                                    </div>
                                </div>
                            </td>
                        </tr>
                ...
                <div class="modal-content">
                    ...
                    <form id="formSubmit" name="formSubmit" method="post">
                        ...
                        <div class="modal-footer">
                            <button id="btnSave" type="button" class="btn btn-success bg-custom-navbar text-white">
    ...
    @push('scripts')
    <script>
        function crudDepartment(action, id = null) {
            $('#formSubmit')[0].reset();
