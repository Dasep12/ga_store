                            ...
                            <td align="center">
                                <div class="position-static"><a class=" dropdown-toggle dropdown-caret-none transition-none btn-reveal" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-cog fs-10"></span></a>
                                    <div class="dropdown-menu dropdown-menu-end py-2">
                                        <a onclick="crudJson('edit','{{ $data->kode_asset }}')" class="dropdown-item text-primary btnEdit"><i class="fa fa-eye"></i> View</a>
                                        <div class="dropdown-divider"></div>
                                        <a onclick="crudJson('delete','{{ $data->kode_asset }}')" class="dropdown-item text-danger btnDelete" href="#!"><i class="fa fa-trash"></i> Remove</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
                    ...
                    <form id="formSubmit" class="form-loading" name="formSubmit" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="kode_asset" name="kode_asset" class="form-control form-control-sm">
                                <small class="text-danger fs-9 error-text" id="error-kode_asset"></small>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Nama</label>
                                <input type="text" id="name" name="name" class="form-control form-control-sm">
                                <small class="text-danger fs-9 error-text" id="error-name"></small>
                            </div>
                            <div class="form-check form-switch mb-3">
                                ...
                                <small class="text-danger fs-9 error-text" id="error-is_actived"></small>
                            </div>
                        </div>
            ...
            if (action === 'create') {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#id').val(data.kode_asset);
                        $('#name').val(data.name);
                        $('#kode_asset').val(data.kode_asset).attr('readonly', 'readonly');
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    ...
                    if (xhr.status === 422) {
                        ...
                        if (errors.kode_asset) {
                            $('#error-kode_asset').text(errors.kode_asset[0]);
                        }
                    }
                }
            });
