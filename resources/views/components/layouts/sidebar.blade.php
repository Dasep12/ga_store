                 ...
                 <li class="nav-item">
                     ...
                     <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-e-masterdata" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-e-masterdata">
                             <div class="d-flex align-items-center">
                                 <div class="dropdown-indicator-icon-wrapper"><span class="fas fa-caret-right dropdown-indicator-icon"></span></div><span class="nav-link-icon"><span data-feather="database"></span></span><span class="nav-link-text">Master</span>
                             </div>
                         </a>
                         <div class="parent-wrapper label-1">
                             <ul class="nav collapse parent bg-custom-navbar" data-bs-parent="#navbarVerticalCollapse" id="nv-e-masterdata">
                                 ...
                                 <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-admin">
                                         <div class="d-flex align-items-center">
                                             <div class="dropdown-indicator-icon-wrapper"><span class="fas fa-caret-right dropdown-indicator-icon"></span></div><span class="nav-link-text">Database</span>
                                         </div>
                                     </a>
                                     <!-- more inner pages-->
                                         ...
                                         <ul class="nav collapse parent show" data-bs-parent="#e-masterdata" id="nv-admin">
                                             <li class="nav-item">
                                                 <a class="nav-link" href="{{ url('departments') }}">
                                                     <div class="d-flex align-items-center"><span class="nav-link-text">Department</span>
                                                     </div>
                                                 </a>
                                                 <!-- more inner pages-->
                                             </li>
                                             <li class="nav-item">
                                                 <a class="nav-link" href="{{ url('kategori') }}">
                                                     <div class="d-flex align-items-center"><span class="nav-link-text">Kategori</span>
                                                     </div>
                                                 </a>
                                                 <!-- more inner pages-->
                                             </li>
                                             <li class="nav-item">
                                                 <a class="nav-link" href="{{ url('units') }}">
                                                     <div class="d-flex align-items-center"><span class="nav-link-text">Unit / Satuan</span>
                                                     </div>
                                                 </a>
                                                 <!-- more inner pages-->
                                             </li>
                                     ...
                                     <div class="parent-wrapper">
                                         <ul class="nav collapse parent show" data-bs-parent="#e-commerce" id="nv-customer">
                                             <li class="nav-item"><a class="nav-link" href="{{ url('product') }}">
                                                     <div class="d-flex align-items-center"><span class="nav-link-text">Reguler</span>
                                                     </div>
                                                 </a>
                                                 <!-- more inner pages-->
                                             </li>
                                             <li class="nav-item"><a class="nav-link" href="{{ url('product') }}">
                                                     <div class="d-flex align-items-center"><span class="nav-link-text">Non Reguler</span>
                                                     </div>
                                                 </a>
                                                 <!-- more inner pages-->
                                             </li>
                     ...
                     <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-e-transaction" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-e-transaction">
                         ...
                         <div class="parent-wrapper label-1">
                             <ul class="nav collapse parent bg-custom-navbar" data-bs-parent="#navbarVerticalCollapse" id="nv-e-transaction">
                                 ...
                                 <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-admin">
                                         <div class="d-flex align-items-center">
                                             <div class="dropdown-indicator-icon-wrapper"><span class="fas fa-caret-right dropdown-indicator-icon"></span></div><span class="nav-link-text">Request Pengadaan</span>
                                         </div>
                                     </a>
                                     <!-- more inner pages-->
                                     <div class="parent-wrapper">
