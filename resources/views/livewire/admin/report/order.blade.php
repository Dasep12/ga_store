<div wire:key="product-table" wire:init="loadData">
    ...
    <div class="card mb-3">
        <div class="card-header">
            <h3>Report Permintaan Barang</h3>
        </div>
        <div class="card-body">
            <form id="filterForm" class="row gy-2 gx-3 align-items-center" wire:submit.prevent="filterData">

                <div class="col-auto">
                    <select class="form-control select2" id="department" wire:ignore name="department"></select>
                </div>
                <div class="col-auto">
                ...
                <table class="table table-sm table-hover table-bordered fs-8">
                    <thead class="bg-custom-navbar">
                        <tr>
                            ...
                            <th class="text-white">No Request</th>
                    ...
                    <tr>
                        ...
                        <td>{{ ucwords($data->order_id) }}</td>
                        <td>{{ ucwords($data->order_date) }}</td>
                        <td>{{ ucwords($data->department) }}</td>
                        <td>{{ ucwords($data->creator) }}</td>
        ...
        document.addEventListener('livewire:initialized', function() {
            ...
            Livewire.hook("morphed", () => {
                ...
                setTimeout(() => {
                    ...
                    $('#department').val(@this.get('department')).trigger('change');
            ...
            function initFilters() {
                loadFilter("{{ route('department.json') }}", "Department", "department");
            ...
            $(document).on('submit', '#filterForm', function(e) {
                ...
                $("#department").val(departments).trigger("change");
            });
