                ...
                <div class="row gx-0 gy-2 w-100 flex-between-center">
                    ...
                    <div class="col-auto order-md-1">
                        <ul class="navbar-nav navbar-nav-icons flex-row me-n2">
                            ...
                            <li class="nav-item"><a class="nav-link px-2 icon-indicator icon-indicator-primary" href="javascript:void(0)" role="button"><span class="text-body-tertiary" data-feather="shopping-cart" style="height:20px;width:20px;"></span><span class="icon-indicator-number">3</span></a></li>
                                            ...
                                            <div class="scrollbar-overlay" style="height: 27rem;">
                                                <div class="px-2 px-sm-3 py-3 notification-card position-relative read border-bottom">
                                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                                        <div class="d-flex">
                                                            <div class="avatar avatar-m status-online me-3"><img class="rounded-circle" src="{{asset('assets/assets/img/team/40x40/30.webp')}}" alt="" />
                                                            </div>
                                        ...
                                        <div class="card-body p-0">
                                            <div class="text-center pt-4 pb-3">
                                                <div class="avatar avatar-xl ">
                                                    <img class="rounded-circle " src="{{ asset('assets/assets/img/team/72x72/57.webp')}}" alt="" />
